...
<body>
	...
	<form method="POST" id="cad_dev" autocomplete="off" action="/web/crud/insert_devolucao.php" onsubmit="exibirNome()">
		...
		<p> ID produto:
			<select name="cd_produto" id="cd_produto" required="" title="Caixa de seleção para escolher o produto" readonly="readonly" tabindex="-1" aria-disabled="true">
		...
		<p> Quantidade: <input type="number" name="quantidade" id="quantidade" pattern="\d+" title="Campo para inserir a quantidade de produtos para devolução" required=""> </p>
