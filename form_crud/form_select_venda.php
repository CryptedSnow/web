...
<body>
	...
	<fieldset>
		<legend> Procurar produto vendido (Atalho = Alt + w) </legend>
		<p> Procurar nome do produto vendido: <input id="nome" accesskey="w" title="Campo para procurar determinado produto vendido pelo nome"/> </p>
	</fieldset>
		...
		<?php 
			...
			foreach ($linhas as $exibir_colunas){
				echo '<tr>';
		 		...
		 		"<a href='/web/form_crud/form_delete_venda.php/#exc_ven' title='Deletar venda'>Excluir</a>".'</td>';
		 		echo '</tr>'; echo '</p>';
			}
		?>
	</table>
	<script type="text/javascript" src="/web/js/venda/select_venda.js"></script>
	<p><a href='/web/planilha/planilha_venda.php' title="Botão de download de planilha de vendas" target="_blank"><button> Gerar planilha de vendas</button></a></p>
