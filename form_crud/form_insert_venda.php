...
<body>
	...
	<p><a href='../planilha/planilha_venda.php' name="Botao" title="Botão de download do relatório de vendas" target="_blank"><button>Donwload do relatório de vendas</button></a></p>
</body>
</html>